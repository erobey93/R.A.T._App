...
//        private async void InitializeMainLayout()
//        {
...
//            {
//                await LoadAnimalDataAsync(_animal.Id);
//            }
//            else
//            {
//                //else if ID is not present than the user is creating a new animal or updating an existing animal 
...
//            AddFieldToGroup(identificationGroup, "Species", speciesTextBox, 100);//FIXME
//            AddFieldToGroup(identificationGroup, "Sex", sexComboBox, 140);
//            AddFieldToGroup(identificationGroup, "Sex", sexTextBox, 140);//FIXME

//            // Add physical characteristics fields
//            AddFieldToGroup(physicalGroup, "Variety", varietyComboBox, 20);
//            AddFieldToGroup(physicalGroup, "Variety", varietyTextBox, 20); //FIXME
//            AddFieldToGroup(physicalGroup, "Color", colorComboBox, 60);
//            AddFieldToGroup(physicalGroup, "Color", colorTextBox, 60); //FIXME
//            AddFieldToGroup(physicalGroup, "Markings", markingComboBox, 100);
//            AddFieldToGroup(physicalGroup, "Markings", markingsTextBox, 100); //FIXME
//            AddFieldToGroup(physicalGroup, "Ear Type", earTypeComboBox, 140);
//            AddFieldToGroup(physicalGroup, "Ear Type", earTypeTextBox, 140); //FIXME
...
//            AddFieldToGroup(housingGroup, "Cage #", cageNumberTextBox, 20); //FIXME
//            AddFieldToGroup(housingGroup, "Breeder", breederInfoComboBox, 60);
//            AddFieldToGroup(housingGroup, "Breeder", breederInfoTextBox, 60); //FIXME
//            AddFieldToGroup(housingGroup, "Genetics", genotypeComboBox, 100);
//            AddFieldToGroup(housingGroup, "Genetics", genotypeTextBox, 100); //FIXME
...
//            AddFieldToGroup(parentageGroup, "Dam", damTextBox, 20); //FIXME
//            AddFieldToGroup(parentageGroup, "Sire", sireComboBox, 60);
//            AddFieldToGroup(parentageGroup, "Sire", sireTextBox, 60); //FIXME
...
//        {
//            if (control == null) return; //hack for now, I need to re-factor to use all combo boxes or something like that 
...
//        private async Task LoadAnimalDataAsync(int animalID)
//        {
...
//            weightTextBox = CreateTextBox(150, 260, weight); // New field
...
//            cageNumberComboBox = CreateComboBox(490, 260, cageNumber); //TODO probably need to change location 
//            cageNumberComboBox.Name = "cageNumberComboBox";
...
//            healthButton = CreateButton("Health Records", 790, 630);
//            healthButton.Click += (sender, e) =>
//            {
...
//        //I may end up deleting this, but I like the idea of having a place for general documents 
...
//            //TODO add weight and cageNumber 
//            //TODO add dob either user enters or it is calculated from the age, or it is left blank
//            // // Add new properties
