...
namespace RATAPPLibrary.Migrations
{
    ...
    [Migration("20250601230336_updateGeneticsRelationshipsinContext")]
    partial class updateGeneticsRelationshipsinContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RATAPPLibrary.Data.Models.Breeding.LitterImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LitterId", "CreatedOn")
                        .IsUnique();

                    b.ToTable("LitterImage");
                });
            ...
            modelBuilder.Entity("RATAPPLibrary.Data.Models.Breeding.LitterImage", b =>
                {
                    b.HasOne("RATAPPLibrary.Data.Models.Breeding.Litter", "Litter")
                        .WithMany("imageUrls")
                        .HasForeignKey("LitterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
