        ...
        private void InitializePedigreeTemplate()
{
    ...
    var pedigreeTemplate = new PdfTemplate
    {
        ...
        Elements = new List<PdfElement>
        {
             // --- Page Header (outside main content area) ---
        new TextElement {
            Type = "Text",
            Text = "TOP LEFT DREAM RODENTRY · AFRMA REGISTERED · ESTABLISHED 2022",
            FontFamily = "Times New Roman",
            FontSize = 10,
            IsBold = true,
            X = 0,
            Y = 5, // Positioned above the top margin
            Width = pageWidth,
            HorizontalAlignment = HorizontalAlignment.Center
        },
            // --- Centered Logo ---
        new ImageElement
        {
            ...
            Y = 25, // Starts below the header area
            Width = logoWidth,
            Height = logoHeight
        },
            ...
            new TextElement {
                ...
                Text = "Top Left Dream Rodentry (TLDR)", // Fallback TODO
                FontFamily = "Times New Roman",
                FontSize = 14,
                X = 150, Y = 160,
                Width = 400, Height = 20
